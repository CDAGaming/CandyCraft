...
public class ClientEventCatcher
{
	...
	{
		if (event.getEntity() != null && event.getEntity() instanceof ICandyBoss && event.getSource().isProjectile() && event.getSource().getEntity() != null && event.getSource().getEntity().getEntityId() == Minecraft.getMinecraft().player.getEntityId())
		{
